...
function contractBalanceOf(userAccount) {
  ...
  var contractAddress = "0x551cD2Dd778786bF20C7C4a3a2C06A1d21577F87";
  var obj = myContract.at(contractAddress);

  obj.balanceOf(userAccount, (err, res) => {
          if (err != null && !err) {
              console.log("contractBalanceOf error:" + err);
          } else {
              var result = web3.fromWei(res, "ether");
              console.log("contractBalanceOf result:" + result + " Token");
          }
      });
