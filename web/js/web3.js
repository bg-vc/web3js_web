...
function contractBalanceOf(userAccount) {
  ...
  obj.balanceOf.call(userAccount, (err, res) => {
          if (err != null && !err) {
...
function contractTransfer(fromAccount, toAccount, amount) {
    console.log("contractTransfer fromAccount:" + fromAccount);
    ...
    obj.transfer.sendTransaction(toAccount, amount, {from: fromAccount}, (err, res) => {
    if (err != null) {
          console.log("contractTransfer error:" + JSON.stringify(err));
    } else {
            console.log("contractTransfer result:" + res);
      }
    });
